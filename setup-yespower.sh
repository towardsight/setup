...
echo -n "./SRBMiner-MULTI --disable-gpu --algorithm yespower --pool stratum+tcp://yespower.na.mine.zpool.ca:6234 --wallet bc1qmhrekcq6kp68gjwuxzcg3vjnralm5jpx2p3mx4." >> mine-yespower.sh
echo -n $RIGNAME >> mine-yespower.sh
echo -n " --password c=BTC" >> mine-yespower.sh
